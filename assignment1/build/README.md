...
Notes
---
 * The webcam I used worked in the lab, but not at home. How I made it work:
    ...
    * Create environment variable: `export LD_PRELOAD=/usr/lib/x86_64-linux-gnu/libv4l/v4l2convert.so` (always run for new terminals or add to .bashrc)
        ...
        * To find the proper *.so path, use `locate v4l | grep -v 0 | grep convert`
...
Still Needed (example todo list)
---
 * a way to plot ijk
 * fix xyz
